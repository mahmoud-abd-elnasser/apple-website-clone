...
//               <div className="w-full h-full rounded-3xl overflow-hidden flex items-center justify-center bg-black">
//                 <video
//                   playsInline={true}
//                   muted
//                   preload="auto"
...
//         <div className="flex justify-center items-center py-5 px-7 backdrop-blur-md bg-zinc-800/50 rounded-full">
  ...
  return (
    <>
      ...
      <div className="relative flex-center mt-10 gap-5">
        <div className="flex-center py-5 px-7 bg-zinc-800/50 backdrop-blur rounded-full">
          {videoRef.current.map((_, i) => (
            <span
              key={i}
              className="mx-2 w-3 h-3 bg-zinc-400 rounded-full relative cursor-pointer"
